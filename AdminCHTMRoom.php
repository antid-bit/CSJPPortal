...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: AdminCHTMRoomview.php");
            exit();
        } else {
...
<head>
    ...
    <title><?php echo $editing ? 'Edit' : 'Add'; ?> CHTM Room</title>
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-semibold mb-6 text-center">
                    <?php echo $editing ? 'Edit' : 'Add'; ?> CHTM Room
                </h1>
                ...
                <form class="space-y-5" action="AdminBSCSRoom.php" method="POST">
                    ...
                    <div>
                        ...
                        <select id="course" name="course" required class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            ...
                            <option value="2" <?php echo ($editing && $current_room['course_id'] == 2) ? 'selected' : ''; ?>>CHTM</option>
                        </select>
                    </div>
