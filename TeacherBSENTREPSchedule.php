...
// Fetch BSENTREP (`course_id = 5`) schedule
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - BSENTREP Schedule</title>
...
<div class="flex">
    ...
    <div class="w-64 bg-blue-900 h-screen relative">
        ...
        <nav class="text-white">
            ...
            <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="TeacherBSENTREPAddStudent.php">
                <i class="fas fa-user-plus mr-2"></i>Add Student
            </a>
            <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="TeacherBSENTREPMasterlist.php">
                <i class="fas fa-chart-bar mr-2"></i>Masterlist
            </a>
            <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="TeacherBSENTREPReports.php">
    ...
    <div class="flex-1 p-8 overflow-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">📅 Weekly Class Schedule (BSENTREP)</h1>
            <a href="/CSJPPortal/TeacherBSENTREPAdd.php" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
                ➕ Add Schedule
            </a>
        </div>
            ...
            <table class="min-w-full bg-white border border-gray-300 text-center text-lg">
                <thead>
                    <tr class="bg-blue-500 text-white text-xl">
                        ...
                        <th class="py-4 px-6 border">Subject ID</th>
                ...
                <tbody>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr class="<?= ($row['day_of_week'] === $today) ? 'bg-yellow-100 font-semibold' : 'hover:bg-gray-50' ?>">
                            ...
                            <td class="py-3 px-4 border"><?= htmlspecialchars($row['subject_id']) ?></td>
                            ...
                            <td class="py-3 px-4 border space-x-2">
                                <form method="POST" action="/CSJPPortal/TeacherBSENTREPDelete.php" onsubmit="return confirm('Are you sure you want to delete this schedule?')" class="inline">
