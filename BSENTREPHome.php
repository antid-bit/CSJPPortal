    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 h-screen relative">
            ...
            <nav class="text-white">
                <a class="block py-2.5 px-4 bg-blue-700 rounded-md mb-2" href="BSENTREPHome.php">
                    <i class="fas fa-home mr-2"></i>Home
                </a>
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSENTREPSchedule.php">
                ...
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSENTREPReports.php">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="bg-blue-700 text-white p-6 rounded-md mb-6">
				...
				<h2 class="text-2x2 font-bold">BSENTREP 3</h2>
            </div>
