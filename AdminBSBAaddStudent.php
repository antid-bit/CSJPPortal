<?php
// AdminBSBAAddStudent.php
session_start();
$_SESSION['course'] = 'BSBA'; // Hardcoded to BSBA
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$user_id) {
        ...
        if ($stmt->execute()) {
            $message = "BSBA student added successfully with ID: " . htmlspecialchars($user_id);
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - BSBA Add Student</title>
...
<a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminCHTMRoom.php">
    <i class="fas fa-door-open mr-2"></i>Room
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">➕ Add BSBA Student</h1>
