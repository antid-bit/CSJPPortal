...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save'])) {
    ...
    $student_id = $_POST['student_id'];  // collected but not saved in DB here
    $course_id = 3;  // CHTM course_id
    ...
    if (empty($message)) {
        ...
        if ($check_result->num_rows > 0) {
            ...
            echo "<script>
                    setTimeout(function() {
                        window.location.href = '/CSJPPortal/TeacherCHTMSchedule.php';
                    }, 2000);
                  </script>";
        } else {
...
<html>
<head>
    <title>Add New Schedule - CHTM</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 p-8">
    <h1 class="text-3xl font-bold mb-6">Add New Schedule Entry (CHTM)</h1>
    ...
    <form method="POST" class="max-w-lg bg-white p-6 rounded shadow-md">
        ...
        <div class="flex justify-between">
            <a href="/CSJPPortal/TeacherCHTMSchedule.php" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Cancel</a>
