...
// Fetch BSBA (`course_id = 4`) subjects only
  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-blue-900 h-screen">
      ...
      <nav class="text-white">
        <a class="block py-2.5 px-4 rounded-md mb-2" href="BSBAHome.php">
          <i class="fas fa-home mr-2"></i>Home
        </a>
        <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSBASchedule.php">
          <i class="fas fa-user-graduate mr-2"></i>Schedule
        </a>
        <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSBALog.php">
          <i class="fas fa-book mr-2"></i>Attendance Log
        </a>
        <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSBAReports.php">
    ...
    <div class="flex-1 p-8 overflow-auto">
      <h1 class="text-3xl font-bold mb-6 text-center">📅 Weekly Class Schedule (BSBA)</h1>
