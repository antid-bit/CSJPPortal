...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $room = $_POST['room'];
    $course_id = 5; // Hardcoded to BSENTREP (course_id = 5)
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: AdminBSENTREPRoomview.php");
            exit();
        } else {
...
<head>
    <meta charset="UTF-8">
    <title><?php echo $editing ? 'Edit' : 'Add'; ?> BSENTREP Room</title>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 min-h-screen">
            ...
            <nav class="text-white">
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminBSENTREPHome.php">
                    <i class="fas fa-home mr-2"></i>Home
                </a>
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminBSENTREPAddStudent.php">
                    <i class="fas fa-user-plus mr-2"></i>Add Student
                </a>
                <a class="block py-2.5 px-4 bg-blue-800 rounded-md mb-2" href="AdminBSENTREPRoom.php">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
                <h1 class="text-2xl font-semibold mb-6 text-center">
                    <?php echo $editing ? 'Edit' : 'Add'; ?> BSENTREP Room
                </h1>
                ...
                <form class="space-y-5" method="POST" action="">
                    ...
                    <div>
                        ...
                        <select id="room" name="room" required class="w-full border border-gray-300 rounded-md px-3 py-2">
                    ...
                    <div>
                        ...
                        <select id="course" name="course" required class="w-full border border-gray-300 rounded-md px-3 py-2">
                            <option value="5" selected>BSENTREP</option> <!-- Locked to BSENTREP -->
                        </select>
                    </div>
