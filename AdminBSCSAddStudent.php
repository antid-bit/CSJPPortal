<?php
session_start();
$_SESSION['course'] = 'BSCS'; // Changed to BSCS
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 h-screen relative">
            ...
            <nav class="text-white">
				...
				<a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminBSCSRoom.php">
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">➕ Add BSCS Student</h1>
