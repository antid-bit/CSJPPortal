...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - BSENTREP</title>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 h-screen relative">
            ...
            <nav class="text-white">
                ...
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2 bg-blue-700" href="TeacherBSENTREPAddStudent.php">
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">➕ Add Student (BSENTREP)</h1>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 text-center">
                ...
                <form method="post" action="">
                    ...
                    <select name="course_id" class="border rounded-md p-2">
                        ...
                        <option value="5" selected>BSENTREP</option> <!-- Default selected -->
                    </select><br><br>
