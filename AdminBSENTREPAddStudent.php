<?php
session_start();
$_SESSION['course'] = 'BSENTREP'; // Changed to BSENTREP
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $course_id = intval($_POST['course_id'] ?? 5); // Changed default to 5 (BSENTREP)
...
<head>
    <meta charset="UTF-8">
    <title>Dashboard - BSENTREP AddStudent</title>
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 h-screen relative">
            ...
            <nav class="text-white">
                ...
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminBSENTREPRoom.php">
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">➕ Add BSENTREP Student</h1>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 text-center">
                ...
                <form method="post" action="">
                    ...
                    <select name="course_id" class="border rounded-md p-2">
                        ...
                        <option value="5" selected>BSENTREP</option> <!-- Default to BSENTREP -->
                    </select><br><br>
