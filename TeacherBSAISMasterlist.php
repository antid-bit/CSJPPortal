...
// Retrieve only BSAIS students
$sql = "SELECT user_id, year_level_id, created_at FROM addstudent WHERE course_id = 2 ORDER BY created_at DESC";
...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <h1 class="text-3xl font-bold mb-6 text-center">📋 BSAIS Student Masterlist</h1>
                ...
                <table class="w-full border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center border-t border-gray-300">
                            ...
                            <td class="p-3">BSAIS</td> <!-- Display course name instead of ID -->
