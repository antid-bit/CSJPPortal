...
// Fetch BSAIS rooms (course_id = 2)
$stmt = $conn->prepare("SELECT * FROM rooms WHERE course_id = 2");
$stmt->execute();
    ...
    <div class="flex">
        ...
        <div class="w-64 bg-blue-900 min-h-screen">
            ...
            <nav class="text-white">
                ...
                <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="AdminBSAISAddStudent.php">
                    <i class="fas fa-user-plus mr-2"></i>Add Student
                </a>
                <a class="block py-2.5 px-4 bg-blue-800 rounded-md mb-2" href="AdminBSAISRoom.php">
        ...
        <div class="flex-1 p-8">
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
                <h1 class="text-2xl font-semibold mb-4 text-center">BSAIS Room List</h1>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr class="text-center bg-gray-50">
                                <td class="py-2 px-4 border">BSAIS</td>
