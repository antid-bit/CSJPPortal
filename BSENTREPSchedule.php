...
// Fetch BSENTREP (`course_id = 5`) subjects only
  ...
  <div class="flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-blue-900 h-screen">
      ...
      <nav class="text-white">
        <a class="block py-2.5 px-4 rounded-md mb-2" href="teacherBSEntrepHome.php">
        ...
        <a class="block py-2.5 px-4 hover:bg-blue-700 rounded-md mb-2" href="BSENTREPlog.php">
    ...
    <div class="flex-1 p-8 overflow-auto">
      <h1 class="text-3xl font-bold mb-6 text-center">📅 Weekly Class Schedule (BSENTREP)</h1>
