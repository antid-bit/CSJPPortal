...
// Fetch BSBA rooms (course_id = 4)
$stmt = $conn->prepare("SELECT * FROM rooms WHERE course_id = 4");
$stmt->execute();
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8">
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
                <h1 class="text-2xl font-semibold mb-4 text-center">BSBA Room List</h1>
                    ...
                    <tbody>
                        <?php while ($row = $result->fetch_assoc()): ?>
                            <tr class="text-center bg-gray-50">
                                <td class="py-2 px-4 border">BSBA</td>
